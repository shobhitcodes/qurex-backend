...
async function bookAppointment(
    ...
    try {
        ...
        const reciept = `PatientBooking-${moment(from).format('DD-MM-YYYY')}-${docDetail.feeCharge}`;
        const paymentOrder = await PaymentService.createOrder(docDetail.feeCharge,reciept,patientId);
